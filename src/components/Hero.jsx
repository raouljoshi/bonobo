...
const Hero = () => {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-b from-gray-950/95 via-gray-950/75 to-gray-950/40"></div>
      <div className="relative z-10 flex w-full max-w-3xl flex-col items-center">
        ...
        <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row sm:gap-4">
          <a href={buildConsultationEmailLink(t('consultation.email_subject'), t('consultation.email_context'))} className="w-full rounded-full bg-brand px-8 py-3 font-bold text-white shadow-lg transition duration-300 hover:bg-brand-dark sm:w-auto">
            {t('hero.button_trial')}
          </a>
